...
def main(csv_path, look_back, split_percent, batch_size, layers):
    ...
    epochs = [25, 50, 100, 200, 400, 800, 1600, 3200, 6400]
    for e in epochs:
        results[str(e)] = experiment(repeats,
                                     series,
                                     e,
                                     look_back,
                                     split_percent,
...
main(r'D:\Shoreline_Extraction_GAN\model_outputs\Delmarva_138.csv', 9, 0.80, 4, 10)
