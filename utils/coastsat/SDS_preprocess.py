...
##    im_NDVI = (im_NIR-im_RGB[:,:,0])/(im_NIR+im_RGB[:,:,0])
##    im_NDWI = (im_NIR-im_SWIR)/(im_NIR+im_SWIR)
##    im_NDVI_raveled = np.ravel(im_NDVI)
##    im_NDWI_raveled = np.ravel(im_NDWI)
...
##    ax1.imshow(im_RGB)
##    ax1.set_title(date + '   ' + satname, fontsize=16)
####    scalebar = ScaleBar(30) # 1 pixel = 10 meter
####    ax1.add_artist(scalebar)
##    # NIR
##    ax2.axis('off')
##    ax2.imshow(im_NDWI, cmap='seismic_r')
##    #plt.colorbar(im_NDWI,ax=ax2)
##    ax2.set_title('NDWI', fontsize=16)
####    scalebar = ScaleBar(30)
####    ax2.add_artist(scalebar)
##    # SWIR
##    ax3.axis('off')
##    ax3.imshow(im_NDVI, cmap='RdYlGn')
##    #plt.colorbar(im_NDVI,ax=ax3)
##    ax3.set_title('NDVI', fontsize=16)
##
##    ax4.hist(im_NDWI_raveled)
##    ax4.set_xlabel('NDWI')
##    ax4.set_ylabel('Count')
##    ax4.set_xlim(-1,1)
##    ax5.hist(im_NDVI_raveled)
##    ax5.set_xlabel('NDVI')
